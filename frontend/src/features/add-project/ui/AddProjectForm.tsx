      ...
      <form onSubmit={handleSubmit}>
        <Stack spacing={2}>
          <TextField
            ...
            error={!!errors.name}
            helperText={errors.name || "For example: 18511 Joy Rd, Detroit, MI 48228, USA"}
            fullWidth
            size="small"
            InputProps={{
              startAdornment: (
          ...
          <TextField
            ...
            helperText={errors.annualPercent || "Annual yield percent of the project"}
            fullWidth
            size="small"
            InputProps={{
              startAdornment: (
            ...
            <DatePicker
              ...
              slotProps={{
                textField: {
                  ...
                  helperText: errors.startDate || "Date when the percent starts accruing",
                  InputProps: {
                    startAdornment: (
